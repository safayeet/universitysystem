...
if ($_SESSION['role'] !== "admin" && $_SESSION['role'] !== "admission") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `teacherdetails`(`teacherid`, `password`, `name`, `location`, `contact`, `department`, `maxcredit`, `takencredit`, `position`, `feedback`, `lastfeedback`)
VALUES ('$teacherid','$password','$teachername','$location',$contact,'$deptid',$maxcredit,0,'$position','5,5,5,5,5,5', '')";
